	...
	if($('#email-form').length){
		$('#submit').click(function(){
            ...
            $.ajax({
                ...
                data: $(form).serialize(),
                beforeSend:function(){
                    $('#email-form .response').html('<div class="text-info"><img src="http://superstorefinder.net/support/wp-content/uploads/2018/01/orange_circles.gif"> Loading...</div>');
                },
